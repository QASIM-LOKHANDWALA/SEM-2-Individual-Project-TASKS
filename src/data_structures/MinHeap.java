...
public class MinHeap implements Iterable<Task> {
    private Task[] Heap;
    private int size;
    private int maxsize;
    ...
    private void minHeapify(int pos) {
        ...
        if (left < size && Heap[left].getTask_priority() < Heap[smallest].getTask_priority())
            smallest = left;
        if (right < size && Heap[right].getTask_priority() < Heap[smallest].getTask_priority())
            smallest = right;
    ...
    private class MinHeapIterator implements Iterator<Task> {
